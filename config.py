...
_C.DATA.high = 0.05
_C.DATA.DA = True
# for testing define the lever of distortion for test_set
_C.DATA.TASK = 'test_1'
...
# Swin Transformer azimuth parameters
_C.MODEL.SWINAZ = CN()
_C.MODEL.SWINAZ.WINDOW_SIZE = (1,16) # change the window size to a tupple
...
def update_config(config, args):
    ...
    # merge from specific arguments # _C.MODEL.XI = 0.0, _C.MODEL.XI_BOOL = False
    if args.xi:
        config.MODEL.XI = args.xi
    if args.xi_bool:
        config.MODEL.XI_BOOL = args.xi_bool
    if args.batch_size:
